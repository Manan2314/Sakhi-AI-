...
const SEED_REPORTS = [
  {
    ...
    pos: [28.6329, 77.2195] as [number, number],
  },
  {
    ...
    pos: [28.5672, 77.2432] as [number, number],
  },
  {
    ...
    pos: [28.5224, 77.2188] as [number, number],
  },
  {
    ...
    pos: [28.5676, 77.2100] as [number, number],
  },
];
...
export default function CommunityReports() {
  ...
  const submitReport = () => {
    ...
    const pin = pendingPin ?? geo.position ?? [28.6329, 77.2195];
    const newReport = {
      id: Date.now(),
      category: newCategory,
      title: newTitle.trim(),
      location: newLocation || "Delhi, India",
      time: "Just now",
      votes: 0,
      verified: false,
      desc: newDesc.trim() || "Reported via Sakhi AI app.",
      pos: pin as [number, number],
    };
